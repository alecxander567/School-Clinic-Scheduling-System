...
class NotificationController
{
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { background: #e8f1f8; font-family: Arial, sans-serif; color: #0f2044; }
        .shell { max-width: 600px; margin: 40px auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(15,32,68,0.10); }
        .header { background: #0f2044; padding: 36px 40px 32px; }
        .header h1 { font-size: 24px; font-weight: bold; color: #ffffff; line-height: 1.3; }
        .header p  { font-size: 14px; color: rgba(255,255,255,0.55); margin-top: 6px; }
        .body   { padding: 36px 40px; }
        .greeting { font-size: 16px; color: #0f2044; margin-bottom: 28px; line-height: 1.6; }
        .priority-badge { background: #e8f1f8; border: 1.5px solid #bed6e8; border-radius: 12px; padding: 20px 24px; text-align: center; margin-bottom: 28px; }
        .priority-badge .label { font-size: 12px; font-weight: bold; letter-spacing: 0.08em; text-transform: uppercase; color: #1e5ba8; margin-bottom: 6px; }
        .priority-badge .number { font-size: 52px; font-weight: bold; color: #0f2044; line-height: 1; }
        .details-card { background: #eef4fd; border-radius: 12px; padding: 20px 24px; margin-bottom: 28px; }
        .card-title { font-size: 11px; font-weight: bold; letter-spacing: 0.08em; text-transform: uppercase; color: #6b8fa7; margin-bottom: 16px; }
        .detail-row { padding: 10px 0; border-bottom: 1px solid #d4e6f1; }
        .detail-row:last-child { border-bottom: none; }
        .detail-icon-cell { width: 36px; vertical-align: middle; font-size: 16px; }
        .detail-key { font-size: 11px; color: #6b8fa7; font-weight: bold; margin-bottom: 2px; }
        .detail-val { font-size: 14px; color: #0f2044; font-weight: bold; }
        .reminders { margin-bottom: 28px; }
        .reminders h3 { font-size: 13px; font-weight: bold; color: #0f2044; margin-bottom: 12px; }
        .reminder-item { margin-bottom: 10px; font-size: 14px; color: #374151; line-height: 1.5; }
        .reminder-dot { color: #1e5ba8; font-weight: bold; margin-right: 6px; }
        .footer { background: #eef4fd; border-top: 1px solid #d4e6f1; padding: 20px 40px; text-align: center; }
        .footer p { font-size: 12px; color: #8fa6ba; line-height: 1.6; }
        .footer strong { color: #1e5ba8; }
    </style>';
    }

    private function iconCalendar(): string
    {
        return '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0f2044" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="16" y1="2" x2="16" y2="6"/></svg>';
    }

    private function iconClock(): string
    {
        return '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0f2044" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 15"/></svg>';
    }

    private function iconHospital(): string
    {
        return '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0f2044" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>';
    }

    private function iconPerson(): string
    {
        return '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0f2044" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>';
    }
        ...
        <div class="shell">
            ...
            <div class="body">
                ...
                <div class="reminders">
                    ...
                    <div class="reminder-item"><span class="reminder-dot">&bull;</span>Arrive at least 10 minutes before your priority number is called.</div>
                    <div class="reminder-item"><span class="reminder-dot">&bull;</span>Bring your student ID and any relevant medical records.</div>
                    <div class="reminder-item"><span class="reminder-dot">&bull;</span>If you cannot attend, please inform the clinic in advance.</div>
                </div>

                <p style="font-size:14px;color:#374151;line-height:1.6;">Thank you for using our clinic services. We look forward to seeing you!</p>
            </div>
            <div class="footer">
        ...
        <div class="shell">
            ...
            <div class="body">
                ...
                <div class="reminders">
                    ...
                    <div class="reminder-item"><span class="reminder-dot">&bull;</span>You will be served in priority order (1, 2, 3&hellip;).</div>
                    <div class="reminder-item"><span class="reminder-dot">&bull;</span>A reminder email will be sent on the day of your appointment.</div>
                    <div class="reminder-item"><span class="reminder-dot">&bull;</span>Please be at the clinic at least 10 minutes before your turn.</div>
                </div>
