...
<?php
    ...
    private function defineMenuItems()
    {
        return [
            ...
            'schedule' => [
                ...
                'label' => 'Schedule',
                'link'  => 'appointments/schedule.php',
                'roles' => ['admin', 'nurse'],
            ],
            'students' => [
                'section' => 'Records',
            ...
            'health-records' => [
                ...
                'link'  => 'health-records/health-records.php',
                'roles' => ['admin', 'nurse'],
            ],
            'dental-records' => [
                'section' => 'Records',
                ...
                'link'  => 'health-records/dental-records.php',
                'roles' => ['admin', 'nurse'],
            ],
            'consultations' => [
                'section' => 'Records',
                ...
                'label' => 'Consultations',
                'link'  => 'appointments/consultations.php',
                'roles' => ['admin', 'nurse', 'student', 'teacher'],
            ],
            'reports' => [
                'section' => 'Manage',
    ...
    {
        $active     = ($this->activeMenu === $key || $this->activeMenu === $item['label'] || $this->activeMenu === $item['link']);
